...
clang --target=aarch64-unknown-none-elf -std=c11 -ffreestanding -fno-builtin -nostdlib -O2 \
      -Wall -Wextra -Werror -Iinclude -Inative/freestanding -c string.c strtol.c printf.c scanf.c crt.c heap.c
clang++ --target=aarch64-unknown-none-elf -std=c++17 -fno-exceptions -fno-rtti -nostdinc++ \
      -ffreestanding -fno-builtin -nostdlib -O2 -Wall -Wextra -Werror -Iinclude -Inative/freestanding -c cxxabi.cpp
