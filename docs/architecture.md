...
interfaces, Unix domain sockets, packet information, raw ICMP sockets, accounts, priorities
and children under another identity; sessions, resource limits, other raw sockets and
network change events are not carried. See [platform](platform.md), [io](io.md),
