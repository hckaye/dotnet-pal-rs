...
use dotnet_pal_rs::runtime::{ModuleInfo, EXECUTE, MAX_NAME, READ, WRITE};
...
pub mod context {
    ...
    use super::*;
    use dotnet_pal_rs::context::{Callback, Ops, ACTIVATION, BUS, FLOATING_POINT, ILLEGAL_INSTRUCTION, SEGMENTATION};
