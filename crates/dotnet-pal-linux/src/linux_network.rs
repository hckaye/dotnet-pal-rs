...
use dotnet_pal_rs::network::{Interface, InterfaceAddress, INTERFACE_ETHERNET, INTERFACE_LOOPBACK, INTERFACE_POINT_TO_POINT, INTERFACE_TUNNEL, INTERFACE_UNKNOWN,
