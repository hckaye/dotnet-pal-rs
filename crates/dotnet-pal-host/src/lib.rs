...
use dotnet_pal_rs::{Header, HostApi, ABI_VERSION, CAP_VM};
...
pub fn validate<const VIRTUAL_MEMORY: bool>() -> bool {
    if VIRTUAL_MEMORY && !validate_vm() { return false; }
...
pub mod services {
    use super::*;
    use dotnet_pal_rs::services::{CAP_CLOCK, CAP_SCHEDULER};
    #[repr(C)]
    pub struct Table {
        header: Header,
...
pub mod kernel {
    use super::*;
    use dotnet_pal_rs::kernel::{Destructor, Entry, HostKernel, ALL};
...
pub mod runtime {
    use super::*;
    use dotnet_pal_rs::port::Lookup;
    use dotnet_pal_rs::runtime::{Host as Table, ModuleInfo, ALL};
...
pub mod support {
    use super::*;
    use dotnet_pal_rs::support::{Host as Table, ALL};
...
pub mod context {
    use super::*;
    use dotnet_pal_rs::context::{Host as Table, Ops, CAP};
...
pub mod topology {
    use super::*;
    use dotnet_pal_rs::topology::{Host as Table, CAP};
...
pub mod process {
    use super::*;
    use dotnet_pal_rs::process::{Host as Table, CAP};
...
pub mod image {
    use super::*;
    use dotnet_pal_rs::image::{Host as Table, UnwindInfo, CAP};
    ...
    impl port::Image for Host {
        ...
        unsafe fn readable(address: usize, size: usize) -> Result<bool> {
            ...
            dotnet_pal_rs::image::readable_from_status(unsafe { f(address, size) })
        }
...
pub mod streams {
    use super::*;
    use dotnet_pal_rs::streams::{Host as Table, CAP};
...
pub mod files {
    use super::*;
    use dotnet_pal_rs::files::{Host as Table, Status, CAP};
    ...
    impl port::Files for Host {
        ...
        unsafe fn set_times(path: &[u8], follow: bool, accessed_ns: Option<u64>, modified_ns: Option<u64>) -> Result<()> {
            call!(set_times(path.as_ptr(), path.len(), follow as u32, accessed_ns.unwrap_or(dotnet_pal_rs::files::TIME_KEEP), modified_ns.unwrap_or(dotnet_pal_rs::files::TIME_KEEP)))
        }
        unsafe fn set_file_times(file: *mut c_void, accessed_ns: Option<u64>, modified_ns: Option<u64>) -> Result<()> {
            call!(set_file_times(file, accessed_ns.unwrap_or(dotnet_pal_rs::files::TIME_KEEP), modified_ns.unwrap_or(dotnet_pal_rs::files::TIME_KEEP)))
        }
...
pub mod sockets {
    use super::*;
    use dotnet_pal_rs::sockets::{Address, Host as Table, PollEntry, CAP};
    ...
    impl port::Sockets for Host {
        ...
        unsafe fn poll(entries: &mut [PollEntry], timeout_ns: u64, channel: Option<u32>) -> Result<()> {
            ...
            let mut ready = 0;
            call!(poll(entries.as_mut_ptr(), entries.len(), timeout_ns, channel.unwrap_or(dotnet_pal_rs::sockets::NO_CHANNEL), &mut ready))
        }
...
pub mod faults {
    use super::*;
    use dotnet_pal_rs::faults::{deliver_raw, Frame, Host as Table, CAP, FRAME_TAG};
...
pub mod system {
    use super::*;
    use dotnet_pal_rs::system::{Host as Table, CAP};
...
pub mod notifications {
    use super::*;
    use dotnet_pal_rs::notifications::{deliver_raw, Host as Table, CAP};
...
pub mod processes {
    use super::*;
    use dotnet_pal_rs::processes::{Host as Table, Spawned, CAP};
...
pub mod terminal {
    use super::*;
    use dotnet_pal_rs::terminal::{Host as Table, CAP};
...
pub mod watches {
    use super::*;
    use dotnet_pal_rs::watches::{Event, Host as Table, CAP};
...
pub mod mappings {
    use super::*;
    use dotnet_pal_rs::mappings::{Host as Table, CAP, PRIVATE, SHARED};
...
pub mod volumes {
    use super::*;
    use dotnet_pal_rs::volumes::{Host as Table, Status, CAP};
...
pub mod network {
    use super::*;
    use dotnet_pal_rs::network::{Host as Table, Interface, InterfaceAddress, CAP};
...
pub mod local_sockets {
    use super::*;
    use dotnet_pal_rs::local_sockets::{Host as Table, CAP};
...
pub mod accounts {
    use super::*;
    use dotnet_pal_rs::accounts::{Account, Host as Table, CAP};
...
pub mod priority {
    use super::*;
    use dotnet_pal_rs::priority::{Host as Table, CAP};
...
pub mod packets {
    use super::*;
    use dotnet_pal_rs::packets::{Host as Table, Info, CAP};
    use dotnet_pal_rs::sockets::Address;
...
pub mod spawn_as {
    ...
    use dotnet_pal_rs::spawn_as::{Host as Table, Identity, CAP};
