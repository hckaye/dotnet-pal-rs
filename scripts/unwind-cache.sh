...
cc -std=c11 -O2 -Wall -Wextra -Werror -Iinclude -c crates/dotnet-pal-posix/native/support_posix.c -o artifacts/support/posix.o
c++ -std=c++17 -O2 -DDOTNET_PAL_SUPPORT=1 -D_LIBUNWIND_IS_NATIVE_ONLY -Iinclude -Icrates/dotnet-pal-build/native \
