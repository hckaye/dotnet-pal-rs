...
cc -std=c11 -O2 -Wall -Wextra -Werror -Iinclude tests/elf.c target/release/libdotnet_pal_rs.a \
  -Wl,--gc-sections -Wl,--export-dynamic -lpthread -ldl -lm -o artifacts/elf/linux
...
cc -std=c11 -O2 -Wall -Wextra -Werror -Iinclude -DPAL_ELF_FAULT_HOST tests/elf.c tests/elf_host.c \
  ...
  target/host-elf/release/libdotnet_pal_rs.a -Wl,--gc-sections -Wl,--export-dynamic -lpthread -ldl -lm -o artifacts/elf/host
