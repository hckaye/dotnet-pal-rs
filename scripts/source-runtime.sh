...
cargo build --release --no-default-features --features host-context,host-support,host-images --target-dir target/host-kernel
...
clang -std=c11 -O2 -fPIC -Wall -Wextra -Werror -Iinclude -c native/images_linux.c -o artifacts/images_host.o
clang -r artifacts/images_host.o artifacts/support_host.o artifacts/host_backend.o artifacts/services_host.o artifacts/kernel_host.o artifacts/runtime_host.o artifacts/context_host.o -o artifacts/host_services_backend.o
